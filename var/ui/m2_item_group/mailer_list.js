ui.m2_item_group.mailer_list = Ext.extend(ui.m2_item_group.grid, {
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_item_group.item_form();
		...
		app.Load('m2_item_group', 'item_form');
	},
	Edit: function(){
		var app = new App({waitMsg: 'Загрузка формы'});
		app.on({
	...
	constructor: function(config)
	{
		...
		ui.m2_item_group.mailer_list.superclass.constructor.call(this, config);
	},
