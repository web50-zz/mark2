ui.m2_item_group.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	cTitle: 'Наименование',
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_item_group/list.js',
						create: 'di/m2_item_group/set.js',
						update: 'di/m2_item_group/mset.js',
						destroy: 'di/m2_item_group/unset.js'
					}
				}),
		...
		ui.m2_item_group.grid.superclass.constructor.call(this, config);
	},
	/**
