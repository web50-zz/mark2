ui.m2_item_group.grid2 = Ext.extend(Ext.grid.EditorGridPanel, {
	cTitle: 'Рассылка',
	pagerSize: 500,
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						 read: 'di/m2_item_group/choice.js'
						 /*
		...
		ui.m2_item_group.grid2.superclass.constructor.call(this, config);
		this.init();
	},
