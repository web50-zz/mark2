ui.m2_category_tabs.main = Ext.extend(ui.m2_category_tabs.grid, {
	bttAdd: "Добавить",
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_category_tabs.form();
		...
		app.Load('m2_category_tabs', 'form');
	},
	Edit: function(){
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('m2_category_tabs')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.m2_category_tabs.main.superclass.constructor.call(this, config);
		this.on({
