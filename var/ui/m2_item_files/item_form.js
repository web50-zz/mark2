ui.m2_item_files.item_form = Ext.extend(Ext.form.FormPanel, {
	Load: function(data){
		var f = this.getForm();
		f.load({
			url: 'di/m2_item_files/get.json',
			params: {_sid: data.id},
	...
	constructor: function(config){
		...
		ui.m2_item_files.item_form.superclass.constructor.call(this, config);
		this.on({
