ui.m2_item_in_groups.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	cCompany: 'Компания',
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_item_in_groups/list.js',
		...
		ui.m2_item_in_groups.grid.superclass.constructor.call(this, config);
	},
	/**
