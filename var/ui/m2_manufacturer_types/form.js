ui.m2_manufacturer_types.form = Ext.extend(Ext.form.FormPanel, {
	formWidth: 400,
	formHeight: 350,
	...
	Load: function(data){
		var f = this.getForm();
		f.load({
			url: 'di/m2_manufacturer_types/get.json',
	...
	Save: function(){
		...
		if (f.isValid()){
			f.submit({
				url: 'di/m2_manufacturer_types/set.do',
	...
	constructor: function(config){
		...
		ui.m2_manufacturer_types.form.superclass.constructor.call(this, config);
		this.on({
