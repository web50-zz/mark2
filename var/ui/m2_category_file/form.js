ui.m2_category_file.form = Ext.extend(Ext.form.FormPanel, {
	formWidth: 480,
	formHeight: 400,
	...
	Load: function(data){
		var f = this.getForm();
		f.load({
			url: 'di/m2_category_file/get.json',
	...
	Save: function(){
		...
		if (f.isValid()){
			f.submit({
				url: 'di/m2_category_file/set.do',
	...
	constructor: function(config){
		...
		ui.m2_category_file.form.superclass.constructor.call(this, config);
		this.on({
