ui.m2_category_file.main = Ext.extend(ui.m2_category_file.grid, {
	bttAdd: "Добавить",
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_category_file.form();
		...
		app.Load('m2_category_file', 'form');
	},
	Edit: function(){
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('m2_category_file')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.m2_category_file.main.superclass.constructor.call(this, config);
		this.on({
