ui.m2_category_file.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	clmnName: "Файл",
	clmnFt: 'Тип',
	clmnTitle: 'Название',
	pagerSize: 50,
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/m2_category_file/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_category_file/list.js',
						create: 'di/m2_category_file/set.js',
						update: 'di/m2_category_file/mset.js',
						destroy: 'di/m2_category_file/unset.js'
					}
				}),
		...
		ui.m2_category_file.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
