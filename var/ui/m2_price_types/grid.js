ui.m2_price_types.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	clmnTitle: "Название",
	clmnId:"Id",
	pagerSize: 50,
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/m2_price_types/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_price_types/list.js',
						create: 'di/m2_price_types/set.js',
						update: 'di/m2_price_types/mset.js',
						destroy: 'di/m2_price_types/unset.js'
					}
				}),
		...
		ui.m2_price_types.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
