ui.m2_price_types.form = Ext.extend(Ext.form.FormPanel, {
	formWidth: 400,
	formHeight: 200,
	...
	lblTitle: 'Название',
	lblPrice: 'Цена если это категория',
	...
	Load: function(data){
		var f = this.getForm();
		f.load({
			url: 'di/m2_price_types/get.json',
	...
	constructor: function(config){
		...
		ui.m2_price_types.form.superclass.constructor.call(this, config);
		this.on({
