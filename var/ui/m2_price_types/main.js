ui.m2_price_types.main = Ext.extend(ui.m2_price_types.grid, {
	bttAdd: "Добавить",
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_price_types.form();
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('m2_price_types')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.m2_price_types.main.superclass.constructor.call(this, config);
		this.on({
