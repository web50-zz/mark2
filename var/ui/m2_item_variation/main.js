ui.m2_item_variation.main = Ext.extend(ui.m2_item_variation.grid, {
	bttAdd: "Добавить",
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_item_variation.form();
		...
		app.Load('m2_item_variation', 'form');
	},
	Edit: function(){
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('m2_item_variation')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.m2_item_variation.main.superclass.constructor.call(this, config);
		this.on({
