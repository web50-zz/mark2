ui.m2_item_variation.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	clmnTitle: "Название",
	clmnId:"Id",
	pagerSize: 50,
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/m2_item_variation/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_item_variation/list.js',
						create: 'di/m2_item_variation/set.js',
						update: 'di/m2_item_variation/mset.js',
						destroy: 'di/m2_item_variation/unset.js'
					}
				}),
		...
		ui.m2_item_variation.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
