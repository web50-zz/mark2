ui.m2_item_manufacturer.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	clmnTitle: "Название",
	clmnType: "Тип",
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/m2_item_manufacturer/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_item_manufacturer/list.js',
						create: 'di/m2_item_manufacturer/set.js',
						update: 'di/m2_item_manufacturer/mset.js',
						destroy: 'di/m2_item_manufacturer/unset.js'
					}
				}),
		...
		Ext.apply(this, {
			...
			colModel: new Ext.grid.ColumnModel({
				...
				columns: [
					...
					{header: this.clmnType, id: 'expand', dataIndex: 'type_title', editor: new fm.TextField({maxLength: 255, maxLengthText: 'Не больше 255 символов'})}
				]
			}),
			/*
		...
		ui.m2_item_manufacturer.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
