ui.m2_item_manufacturer.main = Ext.extend(ui.m2_item_manufacturer.grid, {
	bttAdd: "Добавить",
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_item_manufacturer.form();
		...
		app.Load('m2_item_manufacturer', 'form');
	},
	Edit: function(){
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('m2_item_manufacturer')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.m2_item_manufacturer.main.superclass.constructor.call(this, config);
		this.on({
