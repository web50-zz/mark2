ui.m2_category_chars.form_custom = Ext.extend(Ext.form.FormPanel, {
	formWidth: 500,
	formHeight: 400,
	...
	Load: function(data){
		...
		data.is_custom = 1;
		f.load({
			url: 'di/m2_category_chars/get.json',
	...
	Save: function(){
		...
		if (f.isValid()){
			f.submit({
				url: 'di/m2_category_chars/set.do',
	...
	constructor: function(config){
		...
		ui.m2_category_chars.form_custom.superclass.constructor.call(this, config);
		this.on({
