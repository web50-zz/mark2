ui.m2_item_variation_chars.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/m2_item_variation_chars/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_item_variation_chars/list.js',
						create: 'di/m2_item_variation_chars/set.js',
						update: 'di/m2_item_variation_chars/mset.js',
						destroy: 'di/m2_item_variation_chars/unset.js'
					}
				}),
		...
		Ext.apply(this, {
			...
			enableDragDrop: true,
			ddGroup: 'm2_item_variation_chars',
		...
		ui.m2_item_variation_chars.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
