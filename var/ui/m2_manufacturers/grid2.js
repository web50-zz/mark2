ui.m2_manufacturers.grid2 = Ext.extend(Ext.grid.EditorGridPanel, {
	cContact: 'id',
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						 read: 'di/m2_manufacturers/choice.js'
						 /*
		...
		ui.m2_manufacturers.grid2.superclass.constructor.call(this, config);
		this.init();
	},
