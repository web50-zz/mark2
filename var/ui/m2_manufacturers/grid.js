ui.m2_manufacturers.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	clmnTitle: "Название",
	clmnMTitle: "Тип",
	clmnId:"Id",
	pagerSize: 50,
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/m2_manufacturers/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_manufacturers/list.js',
						create: 'di/m2_manufacturers/set.js',
						update: 'di/m2_manufacturers/mset.js',
						destroy: 'di/m2_manufacturers/unset.js'
					}
				}),
		...
		Ext.apply(this, {
			...
			colModel: new Ext.grid.ColumnModel({
				...
				columns: [
					...
					{header: this.clmnMTitle, id: 'expand', dataIndex: 'manufacturer_title', editor: new fm.TextField({maxLength: 255, maxLengthText: 'Не больше 255 символов'})}
				]
			}),
		...
		ui.m2_manufacturers.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
