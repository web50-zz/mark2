ui.m2_item_category.form = Ext.extend(Ext.form.FormPanel, {
	formWidth: 400,
	formHeight: 100,
	...
	Load: function(data){
		var f = this.getForm();
		f.load({
			url: 'di/m2_item_category/get.json',
	...
	constructor: function(config){
		...
		ui.m2_item_category.form.superclass.constructor.call(this, config);
		this.on({
