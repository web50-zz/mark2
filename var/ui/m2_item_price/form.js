ui.m2_item_price.form = Ext.extend(Ext.form.FormPanel, {
	formWidth: 400,
	formHeight: 300,
	...
	constructor: function(config){
		...
		Ext.apply(this, {
			...
			items: [
				...
				{fieldLabel: this.lblType, hiddenName: 'type', xtype: 'combo',
						...
						store: new Ext.data.JsonStore({url: 'di/m2_price_types/type_list.json', root: 'records', fields: ['id', 'title'], autoLoad: true,
							listeners: {
		...
		ui.m2_item_price.form.superclass.constructor.call(this, config);
		this.on({
