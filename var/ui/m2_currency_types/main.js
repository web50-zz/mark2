ui.m2_currency_types.main = Ext.extend(ui.m2_currency_types.grid, {
	bttAdd: "Добавить",
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_currency_types.form();
		...
		app.Load('m2_currency_types', 'form');
	},
	Edit: function(){
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('m2_currency_types')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.m2_currency_types.main.superclass.constructor.call(this, config);
		this.on({
