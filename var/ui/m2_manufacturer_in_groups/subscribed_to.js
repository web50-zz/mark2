ui.m2_manufacturer_in_groups.subscribed_to = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	addExt: function(list_id,message_id){
		...
		{
			Ext.Ajax.request({
				url: 'di/m2_manufacturer_in_groups/set.do',
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_manufacturer_in_groups/list_subs.js',
		...
		ui.m2_manufacturer_in_groups.subscribed_to.superclass.constructor.call(this, config);
