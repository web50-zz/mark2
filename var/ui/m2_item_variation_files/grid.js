ui.m2_item_variation_files.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	constructor: function(config)
	{
		...
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_item_variation_files/list.js',
						create: 'di/m2_item_variation_files/set.js',
						update: 'di/m2_item_variation_files/mset.js',
						destroy: 'di/m2_item_variation_files/unset.js'
					}
				}),
		...
		ui.m2_item_variation_files.grid.superclass.constructor.call(this, config);
		this.init();
	},
