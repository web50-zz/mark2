ui.m2_item_text.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/m2_item_text/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/m2_item_text/list.js',
						create: 'di/m2_item_text/set.js',
						update: 'di/m2_item_text/mset.js',
						destroy: 'di/m2_item_text/unset.js'
					}
				}),
		...
		ui.m2_item_text.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
