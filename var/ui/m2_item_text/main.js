ui.m2_item_text.main = Ext.extend(ui.m2_item_text.grid, {
	bttAdd: "Добавить",
	...
	Add: function(){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_item_text.form();
	...
	constructor: function(config)
	{
		Ext.apply(this, {
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('m2_item_text')}}
			]
		});
		config = config || {};
		Ext.apply(this, config);
		ui.m2_item_text.main.superclass.constructor.call(this, config);
		this.on({
