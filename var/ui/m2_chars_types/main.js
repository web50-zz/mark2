ui.m2_chars_types.main = Ext.extend(ui.m2_chars_types.tree, {
...
/*
	AddGroup: function(pid){
		...
		app.on({
			apploaded: function(){
				var f = new ui.m2_chars_types.group_form();
		...
		app.Load('m2_chars_types', 'group_form');
	},
...
*/
	...
	constructor: function(config){
		...
		ui.m2_chars_types.main.superclass.constructor.call(this, config);
		this.on({
