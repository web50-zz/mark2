ui.m2_chars_types.tree = Ext.extend(Ext.tree.TreePanel, {
	reload: function(id){
		if (id){
	...
	constructor: function(config){
		config = config || {};
		Ext.apply(this, {
			loader: new Ext.tree.TreeLoader({url: 'di/m2_chars_types/slice.json'}),
		...
		ui.m2_chars_types.tree.superclass.constructor.call(this, config);
		this.on({
