ui.m2_import.main = Ext.extend(ui.m2_import.grid, {
	Load: function(data){
		this.setParams({}, true);
	},
	Add: function(){
	...
	constructor: function(config)
	{
		...
		Ext.apply(this, {
			...
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('m2_import')}}
			]
		});
		Ext.apply(this, {
			listeners: {
		...
		ui.m2_import.main.superclass.constructor.call(this, config);
	},
