ui.m2_manufacturer_files.item_form = Ext.extend(Ext.form.FormPanel, {
	Load: function(data){
		var f = this.getForm();
		f.load({
			url: 'di/m2_manufacturer_files/get.json',
			params: {_sid: data.id},
	...
	Save: function(){
		...
		if (f.isValid()){
			f.submit({
				url: 'di/m2_manufacturer_files/set.do',
	...
	constructor: function(config){
		...
		ui.m2_manufacturer_files.item_form.superclass.constructor.call(this, config);
		this.on({
