...
* @package	SBIN Diesel
*/
class di_m2_manufacturer_files extends data_interface
{
	public $title = 'm2: Маркет 2 - файлы производителей';
	/**
	...
	*/
	protected $name = 'm2_manufacturer_files';

	/**
	* @var	string	$path_to_storage	Путь к хранилищу файлов каталога
	*/
	public $path_to_storage = 'mark2/m2_manufacturer_files/';
	...
	*/
	...
	{
		return array(
			array('di' => 'm2_manufacturers', 'event' => 'onUnset', 'handler' => 'unset_for_item'),
		);
	}
