...
* @package	SBIN Diesel
*/
class di_m2_item_manufacturer extends data_interface
{
	public $title = 'm2: Маркет 2 - айтем цена';
	...
	*/
	protected $name = 'm2_item_manufacturer';
	...
	*/
	...
	protected function sys_list()
	{
		...
		$di = $this->join_with_di('m2_manufacturers',array('manufacturer_id'=>'id'),array('title'=>'title'));
		$di2 = $this->join_with_di('m2_manufacturer_types',array('type'=>'id'),array('title'=>'type_title'),$di);
		$this->extjs_grid_json(array('id', 'order', 
