...
* @package	SBIN Diesel
*/
class di_m2_manufacturer_in_groups extends data_interface
{
	...
	*/
	protected $name = 'm2_manufacturer_in_groups';
	...
	*/
	...
	{
		$this->_flush(true);
		$cnt = $this->join_with_di('m2_manufacturers', array('item_id' => 'id'), array('title' => 'title'));
		$cntt = $cnt->get_alias();
...
//9* список  с именами  листов рассылок
	...
	*/
	...
	{
		return array(
			array('di' => 'm2_manufacturers', 'event' => 'onUnset', 'handler' => 'unset_for_contact'),
			array('di' => 'm2_manufacturer_group', 'event' => 'onUnset', 'handler' => 'unset_for_maillist'),
		);
	}
}
?>
