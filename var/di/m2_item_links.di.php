...
* @package	SBIN Diesel
*/
class di_m2_item_links extends data_interface
{
	public $title = 'm2: Маркет 2 - Элемент связка с другими';
	...
	*/
	public $fields = array(
		...
		'linked_item_id' => array('type' => 'integer', 'alias' => 'pid'),
	...
	protected function sys_list()
	{
		...
		$di =  $this->join_with_di('m2_item_link_types',array('type'=>'id'),array('title'=>'type_str'));
